...
class _FlutterFlowGoogleMapState extends State<FlutterFlowGoogleMap> {
  ...
  void _initializeMap() async {
    await _controller.setMapStyle(googleMapStyleStrings[widget.style]);
    _controller
        .moveCamera(CameraUpdate.newLatLngZoom(initialPosition, initialZoom));
    // Resto de la inicialización del mapa, si es necesario
  }
}
